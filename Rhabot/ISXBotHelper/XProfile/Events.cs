...
{	
	...
	internal enum ProfileChangeType
	{
		/// <summary> 
	...
	internal class ProfileChangedArgs : EventArgs
	{   
		// Fields
	...
	/// <seealso cref="ProfileChangedArgs" />
	internal class ProfileChangingArgs : ProfileChangedArgs
	{   
	...
	internal delegate void ProfileChangingHandler(object sender, ProfileChangingArgs e);
	...
	///   This definition complies with the .NET Framework's standard for event handlers.
	///   The sender is always set to the Profile object that raised the event. </remarks>
	internal delegate void ProfileChangedHandler(object sender, ProfileChangedArgs e);
}
